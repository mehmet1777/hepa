  ...
  return (
    <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-lg p-6 space-y-4 border border-slate-600">
      ...
      <button
        ...
        className="w-full py-3 bg-green-600 text-white font-bold text-base rounded-lg hover:bg-green-500 active:bg-green-700 transition-colors touch-manipulation flex items-center justify-center gap-2"
      >
